...
def main():
    ...
    """
    original_fire = SimpleImage('Assignments/Assignment3/images/greenland-fire.png')
    original_fire.show()
    highlighted_fire = highlight_fires('Assignments/Assignment3/images/greenland-fire.png')
